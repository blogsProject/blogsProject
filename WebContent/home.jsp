				...
				<section>
					...
					<section>
						...
						<div class="pretty circle">
							<input type="radio" name="gender" checked="checked" value="男"> <label><i
					...
					<input name="about" class="bootstrap-frm2" type="button"
						onclick="submitcheck()" value="注册">
				</section>
			</form>
		</div>
		...
		<section id="container">
			<div class="wrap-container">
				<div id="main-content">
					...
					<div class="rizhi">
						<div class="rizhi1">
							<a href="#"><h3 class="news">标题</h3></a> 作者:阅读数:发表时间:
						</div>
						<div class="rizhi1">
							<a href="#"><h3 class="news">标题</h3></a> 作者:阅读数:发表时间:
						</div>
