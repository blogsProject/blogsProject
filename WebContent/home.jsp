	...
	<div class="wrap-body">
		...
		<div id="contentid" class="none">
			<form action="UserController" method="post">
				...
				<section>
					<span class="input input--isao"> <input name="username"
					...
					</span> <span class="input input--isao"> <input name="password"
					...
					</span> <input type="hidden" name="flag" value="login" /> <input
						class="bootstrap-frm2" type="submit" value="登录">
				</section>
			</form>
		</div>
		...
		<div id="contentid2" class="none">
			<form name="regeistform" action="UserController" method="post">
				...
				<section>
					<span class="input input--isao"> <input name="username"
						id="username" onblur="checkuserexits()"
						class="input__field input__field--isao" type="text" id="input-38" />
						<label class="input__label input__label--isao" for="input-38"
						data-content="用户名"> <span
							class="input__label-content input__label-content--isao">用户名</span>
						...
						id="password1" class="input__field input__field--isao"
						type="password" id="input-39" /> <label
						class="input__label input__label--isao" for="input-39"
						data-content="密码"> <span
							class="input__label-content input__label-content--isao">密码</span>
					</label>
					</span> <span class="input input--isao"> <input id="password2"
						class="input__field input__field--isao" type="password"
						id="input-39" /> <label class="input__label input__label--isao"
						for="input-39" data-content="再次输入密码"> <span
							class="input__label-content input__label-content--isao">再次输入密码</span>
					</label>
					</span> <span class="input input--isao"> <input name="netname"
						id="netname" class="input__field input__field--isao" type="text"
						id="input-39" /> <label class="input__label input__label--isao"
						for="input-39" data-content="昵称"> <span
							class="input__label-content input__label-content--isao">昵称</span>
					</label>
					</span> <span class="input input--isao"> <input name="relname"
						id="relname" class="input__field input__field--isao" type="text"
						id="input-39" /> <label class="input__label input__label--isao"
						for="input-39" data-content="真实姓名（可不填）"> <span
							class="input__label-content input__label-content--isao">真实姓名（可不填）</span></label>
					</span>
					<section>
						<label>选择你的性别:</label>
						...
						<div class="pretty circle">
							<input type="radio" name="gender" value="女"> <label><i
								class="default"></i>女</label>
						</div>
					</section>
					<textarea name="about" class="bootstrap-frm1"
						placeholder="个人简介（可不填）"></textarea>
					<input class="bootstrap-frm2" type="button" onclick="submitcheck()"
						value="注册">
				</section>
			</form>
		</div>
...
-->
				...
				<div id="main-content">
					...
					<div class="rizhi">
						<c:forEach items="${AlllogList}" var="log">
							<div class="rizhi1">
								<a href="LogController?flag=selectById&lid=${log.lid }"><h3
										class="news">${log.ltitle }</h3></a> 作者:${log.uname }
								阅读数:${log.readnum } 发表时间:${log.ltime }
							</div>
						</c:forEach>
					</div>
 ...
 下一页
				...
				<div id="write">
					<a href="write.jsp"><button style="margin: 0 80px;"
							class="bootstrap-frm2">发表日志</button></a>
				</div>
				<div class="ph">
					<h3>排行</h3>
					<c:forEach items="${readList}" var="log">
						<div class="rizhi3">
							<a href="LogController?flag=selectById&lid=${log.lid }"><h6
									class="news">${log.ltitle }</h6></a> <br> 阅读数:${log.readnum }
							<br>
						</div>
					</c:forEach>
				</div>
