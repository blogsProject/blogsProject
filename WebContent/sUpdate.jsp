...
<div class="div1">
用&nbsp;&nbsp;户&nbsp;&nbsp;名：<input class="input1" type="text" >
<br>
昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：<input class="input1" type="text" >
<br>
真实姓名：<input style="margin-bottom: 20px;" class="input1" type="text"">
<br>
...
<input type="radio" name="radio1">
      ...
      <br><br><br>
个人简介：  <textarea  class="bootstrap-frm3" ></textarea>
<input class="bootstrap-frm2" type="submit" value="点击修改">
</div>
